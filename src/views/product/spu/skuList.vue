  ...
  <el-card>
    <el-form label-width="100px" :model="sku" :rules="rules" ref="skuForm">
      ...
      <el-form-item label="规格描述" prop="skuDesc">
        <el-input type="textarea" placeholder="请输入规格描述" v-model="sku.skuDesc"></el-input>
      </el-form-item>
      <el-form-item label="平台属性" prop="skuAttrValueList">
        <div v-for="(attr, index) in attrList" :key="attr.id" class="skulist-select-container">
      ...
      <el-form-item label="销售属性" prop="skuSaleAttrValueList">
        <div
          ...
          :key="sale.id"
        >
          <el-form-item style="display: inline-block" :label="sale.saleAttrName">
            <el-select
              placeholder="请选择"
